...
For information about describing customers' interactions with UI, see [Procedures and instructions](../../procedures-instructions/).
...
To avoid confusion, it's OK to add the character in parentheses after spelling out the name.**Example**Plus sign (+)
...
**Examples**Ctrl+Shift+? Ctrl+Shift+\* Ctrl+Shift+Comma

**See also**[Special character term collection](special-characters)
