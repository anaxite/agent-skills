...
For an overview of Microsoft accessibility policies, see [Accessibility guidelines and requirements](../../accessibility/accessibility-guidelines-requirements).

To learn more about writing that conveys respect to all people and promotes equal opportunities, see the [Guidelines for Inclusive Language](https://www.lsadc.org/guidelines_for_inclusive_language) from the Linguistic Society of America.
